...
if not controllerConnected:
    pause_texts = [FONT_MD.render("GAME PAUSED", True, ORANGE),
                   FONT_SM.render("Press 'p' to resume.", True, ORANGE)]

    start_texts = [FONT_MD.render(TITLE, True, ORANGE),
                   FONT_SM.render("Press SPACE to start.", True, ORANGE)]

    end_texts = [FONT_XL.render("GAME OVER!", True, RED),
                 FONT_MD.render("Press 'r' to restart", True, RED)]
else:
    pause_texts = [FONT_MD.render("GAME PAUSED", True, ORANGE),
                   FONT_SM.render("Press START to resume.", True, ORANGE)]

    start_texts = [FONT_MD.render(TITLE, True, ORANGE),
                   FONT_SM.render("Press START to start.", True, ORANGE)]
